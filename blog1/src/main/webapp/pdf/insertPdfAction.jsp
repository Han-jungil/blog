...
<%
	...
	*/
	...
	String path = application.getRealPath("pdfupload"); // applicaption변수는 톰켓을 가르키는 변수!
	...
	if(pdfType.equals("application/pdf")) { //db에 저장...
		...
		File file = new File(path + "\\" + pdfName); // java.io.File으로 잘못된 파일을 불러온다.
